module i2c_config (
    ...
    // WM8731 register writes: {reg_addr[6:0], data[8:0]}
    ...
    initial begin
        ...
        config_rom[8] = {7'h07, 9'h002}; // Digital audio interface: I2S, 16-bit, slave
            ...
            case (state)
                ...
                ACK: begin
                    case (phase)
                        2'd0: begin
                            i2c_sclk <= 1'b0;
                            sdat_oe <= 1'b0; // release SDA
                            phase <= 2'd1;
                        end

                        2'd1: begin
                            i2c_sclk <= 1'b1; // slave ACK burada okunabilir
                            phase <= 2'd2;
                        end
